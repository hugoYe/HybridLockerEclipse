...
class CoreAndroid extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args,
		...
		try {
			if (action.equals("clearCache")) {
				...
				// webview.
				// I recommend we change the name of the Message as spinner/stop
				// is not
	 ...
	 * 
	 * @param props
	 *            Properties that can be passed in to the Cordova activity (i.e.
	 *            loadingDialog, wait, ...)
	 */
	...
	/**
	 * Override the default behavior of the Android volume buttons. If
	 * overridden, when the volume button is pressed, the
	 * "volume[up|down]button" JavaScript event will be fired.
	 * 
	 * @param button
	 *            volumeup, volumedown
	 * @param override
	 ...
	 * to all plugins using CordovaActivity.onMessage("telephone", "ringing" |
	 * "offhook" | "idle")
	 */
				...
				if ((intent != null)
					...
					if (intent.hasExtra(TelephonyManager.EXTRA_STATE)) {
						...
						if (extraData
							...
							webView.getPluginManager().postMessage("telephone",
									"ringing");
						} else if (extraData
