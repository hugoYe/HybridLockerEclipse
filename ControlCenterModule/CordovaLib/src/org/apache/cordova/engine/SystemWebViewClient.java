...
public class SystemWebViewClient extends WebViewClient {
	...
	public void onReceivedHttpAuthRequest(WebView view,
		...
		if (pluginManager != null
				&& pluginManager.onReceivedHttpAuthRequest(null,
	...
	public void onReceivedClientCertRequest(WebView view,
		...
		PluginManager pluginManager = this.parentEngine.pluginManager;
		if (pluginManager != null
				&& pluginManager.onReceivedClientCertRequest(null,
	...
	public void onReceivedSslError(WebView view, SslErrorHandler handler,
		...
		if (parentEngine.cordova.getActivity() != null) {
			packageName = parentEngine.cordova.getActivity().getPackageName();
			pm = parentEngine.cordova.getActivity().getPackageManager();
		} else if (parentEngine.cordova.getContext() != null) {
			packageName = parentEngine.cordova.getContext().getPackageName();
			pm = parentEngine.cordova.getContext().getPackageManager();
		}
	...
	public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
		try {
			// Check the against the whitelist and lock out access to the
			// WebView directory
			...
			if (!origUri.equals(remappedUri)
					|| needsSpecialsInAssetUrlFix(origUri)
					|| needsKitKatContentUrlFix(origUri)) {
				CordovaResourceApi.OpenForReadResult result = resourceApi
						.openForRead(remappedUri, true);
			...
			if (!(e instanceof FileNotFoundException)) {
				LOG.e(TAG,
						"Error occurred while loading a file (returning a 404).",
						e);
			}
			// Results in a 404.
			return new WebResourceResponse("text/plain", "UTF-8", null);
