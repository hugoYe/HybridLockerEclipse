...
public final class AndroidInput implements Input, OnKeyListener, OnTouchListener {
	class KeyEvent {
		...
		static final int KEY_TYPED_CHINESE = 3;
	...
	public AndroidInput (AndroidApplication activity,Context context, View view, AndroidApplicationConfiguration config) {
		...
		this.config = config;
		this.onscreenKeyboard = new AndroidOnscreenKeyboard(mContext, new Handler(), this);
...
// onscreenKeyboard.setVisible(visible);
	...
	public void registerSensorListeners () {
		...
		if (config.useCompass) {
			if (manager == null) manager = (SensorManager)mContext.getSystemService(Context.SENSOR_SERVICE);
...
//		}
	...
	public void setCurrentEventTime(long time) {
		currentEventTimeStamp = time;
	}
