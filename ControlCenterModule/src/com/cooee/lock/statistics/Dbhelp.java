...
public class Dbhelp extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_TABLE = "CREATE TABLE locktable (_id INTEGER PRIMARY KEY,num INTEGER)";
	...
	public boolean onSerch(SQLiteDatabase db, String table) {
		Cursor cursor = null;
	...
	public void onCreateTable(SQLiteDatabase db, String table) {
		String CREATE_TABLE = "CREATE TABLE " + table
				+ " (_id INTEGER PRIMARY KEY,num INTEGER)";
		db.execSQL(CREATE_TABLE);
	}
}
