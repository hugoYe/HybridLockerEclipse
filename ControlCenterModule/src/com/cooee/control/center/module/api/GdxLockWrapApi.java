...
abstract public class GdxLockWrapApi implements IWrap, UnlockListener {
	...
	abstract public InputAdapter getInputAdapter();

	public GdxLockWrapApi(Context context) {
	...
	public void onCreate() {
		...
		InputAdapter input = getInputAdapter();
		mLockView.setupViews(mCustomLockView, input);
	}
