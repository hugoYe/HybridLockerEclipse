...
public class DownloadTask extends AsyncTask<String, Integer, String> {
	...
	public DownloadTask(Context context, int id, String title, int srcId) {
		...
		this.title = title;
		this.iconID = srcId;
		this.tip_download = context.getResources().getString(
				R.string.alter_download);
	...
	protected void onPostExecute(String result) {
		...
		it.setAction("com.cooeelock.core.plugin.jsdata");
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message message) {
			switch (message.what) {
			case PREPARE:
				mRemoteViews.setProgressBar(R.id.progressbar_progress,
						fileSize, 0, false);
				break;
			case COMPLETED:
