...
public class PluginProvider extends ContentProvider {
	...
	static final String PERSIONS_TYPE_JS = "vnd.android.cursor.dir/jsplugin";
	static final String PERSION_ITEM_TYPE_JS = "vnd.android.cursor.item/jsplugin";
	// 返回码
	...
	public static Uri PLUGIN_CONTENT_URI_JS;
	...
	public boolean onCreate() {
		...
		uriMatcher.addURI(AUTHORITY, "jsplugin", CODES);
		uriMatcher.addURI(AUTHORITY, "jsplugin/#", CODE);
		PLUGIN_CONTENT_URI_JAR = Uri.parse("content://" + AUTHORITY
				+ "/jarplugin");
		PLUGIN_CONTENT_URI_APK = Uri.parse("content://" + AUTHORITY
				+ "/apkplugin");
		PLUGIN_CONTENT_URI_JS = Uri.parse("content://" + AUTHORITY
				+ "/jsplugin");
		return false;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		} else if (uri.toString().contains("jsplugin")) {
			table = DBHelper.TABLE_JS;
		}
		Log.v("###********######", "table =  " + table);
	...
	public String getType(Uri uri) {
		...
		if (uri.toString().contains("jarplugin")) {
			...
			presionsType = PERSIONS_TYPE_JS;
			presionsItemType = PERSION_ITEM_TYPE_JS;
		}
		switch (uriMatcher.match(uri)) {
		case CODES:
