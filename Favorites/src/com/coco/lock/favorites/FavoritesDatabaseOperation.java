...
import com.coco.lock.favorites.R;
...
public class FavoritesDatabaseOperation{
	...
	public static class Favorites implements BaseColumns {
		...
		/**
		 * The launch times of app, a factor to decide favorite.
		 * <p>
		 * Type: INTEGER
		 * </p>
		 */
	...
	synchronized public void loadDefaultFavoritesIfNecessary(
		...
		if (sp.getBoolean(EMPTY_TABLE_APPS_CREATED, false)) {
			...
			mOpenHelper.loadDefaultFavorites(allApps,
					mOpenHelper.getWritableDatabase(), R.xml.default_favorites);
			editor.commit();
		}
	}
			...
			try {
				...
				while (((type = parser.next()) != XmlPullParser.END_TAG || parser
					...
					if (TAG_FAVORITE.equals(name)
						...
						packageName = a
								.getString(R.styleable.Default_packageName);
						long num = 0;
						String pn = null;
