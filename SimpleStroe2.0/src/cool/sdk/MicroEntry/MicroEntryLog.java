...
public class MicroEntryLog {
	...
	private static void LogItem(Context context, String action,
	...
	public static void LogActive(Context context, MicroEntryLogItem item) {
	...
	public static void LogDelete(Context context, MicroEntryLogItem item) {
		synchronized (syncObj) {
