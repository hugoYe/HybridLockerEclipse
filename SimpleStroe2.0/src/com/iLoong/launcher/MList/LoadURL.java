...
public class LoadURL {
	...
	// 微入口的平台版本号 唯一定义 在 MicroEntryHelper.PLAFORM_VERSION
	static final int MicrVersion = MicroEntryHelper.PLAFORM_VERSION;

	public static String loadUrl(Context context) {
		try {
			String str = "h1:" + phoneInfoma.h1 + "|" + "h2:" + phoneInfoma.h2
					+ "|" + "h3:" + phoneInfoma.h3 + "|" + "h4:"
					+ phoneInfoma.h4 + "|" + "h5:" + phoneInfoma.h5 + "|"
					+ "h6:" + phoneInfoma.h6 + "|" + "h7:" + phoneInfoma.h7
					+ "|" + "h8:" + phoneInfoma.h8 + "|" + "h9:"
					+ phoneInfoma.h9 + "|" + "h10:" + phoneInfoma.h10 + "|"
					+ "h11:" + phoneInfoma.h11 + "|" + "h12:" + phoneInfoma.h12
					+ "|";
			return str;
		} catch (Throwable e) {
	...
	public static String BaseDetalFolder64Str(Context context, String pkgName) {
		String deskey = "8ufD05pL";
		String str = loadUrl(context) + "h13:" + 0 + "|h14:"
				+ MceInfo.instance(context).getH14() + "|h15:" + pkgName
				+ "|h16:folder" + "|h17:"
				+ Utility.googlePalyIsInstall(context) + "|h18:20150623";
		byte[] bs = null;
		try {
	...
	public static String Base64Str(Context context, int id) {
		String deskey = "8ufD05pL";
		// added by zfshi for language h14
		String str = loadUrl(context) + "h13:" + id + "|h14:"
				+ MceInfo.instance(context).getH14() + "|h17:"
				+ Utility.googlePalyIsInstall(context) + "|h18:20150623";
		// added by zfshi for language h14 ended
		byte[] bs = null;
		try {
			bs = DES.ecb_encode(deskey, str);
		} catch (Exception e) {
	...
	// * @throws Exception 异常
	// */
	public static void initPhoneInfoma(Context context) {
		int simIdx = 1;
		...
		try {
			phoneInfoma.h11 = CooeeSdk.cooeeGetLcdWidth(context) + "*"
					+ CooeeSdk.cooeeGetLcdHeight(context);
		} catch (Exception e) {
			phoneInfoma.h11 = "";
		}
