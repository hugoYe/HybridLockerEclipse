...
public class MceInfo {
	...
	public static MceInfo instance(Context context) {
		if (null == mceInfo) {
	...
	public MceInfo(Context context) {
		...
		try {
			h11 = CooeeSdk.cooeeGetLcdWidth(context) + "*"
		...
		try {
			h14 = localeGetSysLanguage(context);
		} catch (Exception e) {
			h14 = "en_US";
		}
	}
	...
	private String localeGetSysLanguage(Context context) {
