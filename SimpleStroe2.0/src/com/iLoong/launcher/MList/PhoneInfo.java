...
public class PhoneInfo {
	...
	public void initPhoneInfo(Context context) {
		...
		try {
			a04 = URLEncoder.encode(
					(CooeeSdk.cooeeGetLcdWidth(context) > CooeeSdk
							.cooeeGetLcdHeight(context)) ? (CooeeSdk
							.cooeeGetLcdWidth(context) + "*" + CooeeSdk
							.cooeeGetLcdHeight(context)) : (CooeeSdk
							.cooeeGetLcdHeight(context) + "*" + CooeeSdk
							.cooeeGetLcdWidth(context)), "UTF-8");
		} catch (UnsupportedEncodingException e) {
		}
		try {
		...
		try {
			a08 = URLEncoder.encode(CooeeSdk.cooeeGetBuildManufacturer(),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a10 = URLEncoder
					.encode(CooeeSdk.cooeeGetBuildBootloader(), "UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			a10 = "";
		...
		try {
			a14 = URLEncoder.encode(CooeeSdk.cooeeGetBuildVersionRelease(),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a15 = URLEncoder
					.encode(Integer.toString(CooeeSdk.cooeeGetVersionSdkInt()),
							"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a17 = URLEncoder.encode(CooeeSdk.cooeeGetVersionIncremental(),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a18 = URLEncoder.encode(Long.toString(CooeeSdk.cooeeGetTotalMem()),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a19 = URLEncoder.encode(
					Long.toString(CooeeSdk.cooeeGetAvailMem(context)), "UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			a19 = null;
		...
		try {
			a20 = URLEncoder.encode(Long.toString(CooeeSdk.cooeeGetTotalRom()),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		...
		try {
			a21 = URLEncoder.encode(Long.toString(CooeeSdk.cooeeGetAvailRom()),
					"UTF-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
