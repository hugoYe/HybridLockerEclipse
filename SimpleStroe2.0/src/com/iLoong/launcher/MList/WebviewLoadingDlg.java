...
public class WebviewLoadingDlg extends Dialog {
	...
	public WebviewLoadingDlg(Context mContext) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(RR.layout.cool_ml_webview_loading_dlg);

		view = (ImageView) findViewById(RR.id.cool_ml_ivProcessImg);
	...
	static Dialog ssdialog = null;

	public static void ShowDlg(Context mContext) {
		// TODO Auto-generated method stub
