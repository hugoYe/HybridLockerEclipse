...
public class AppConfig {
	...
	private boolean usetimeimg = false;

	private int weatherImgX = 0;
	private int weatherImgY = 0;
	private int weatherStrX = 0;
	private int weatherStrY = 0;
	private int cityX = 0;
	private int cityY = 0;
	private int weatherStrfontSize = 36;
	private int cityfontSize = 45;

	private int wddxX = 0;
	private int wddxY = 0;
	private int wjdhX = 0;
	private int wjdhY = 0;
	private int wdxxfontsize = 20;
	...
	public int wdxxfontsize() {
		return wdxxfontsize;
	}

	public int weatherImgX() {
		return weatherImgX;
	}

	public int weatherImgY() {
		return weatherImgY;
	}

	public int weatherStrX() {
		return weatherStrX;
	}

	public int weatherStrY() {
		return weatherStrY;
	}
	...
	public int weatherStrfontSize() {
		return weatherStrfontSize;
	}

	public int cityfontSize() {
		return cityfontSize;
	}
	...
	private void readItem(String itemName, String itemValue) {
		...
		} else if (itemName.equals("systemWallpaper")) {// systemWallpaper
		...
		} else if (itemName.equals("dataX")) {// data
			dataX = Integer.parseInt(itemValue);
		} else if (itemName.equals("dataY")) {
			dataY = Integer.parseInt(itemValue);
		} else if (itemName.equals("weatherImgX")) {
			weatherImgX = Integer.parseInt(itemValue);
		} else if (itemName.equals("weatherImgY")) {
			weatherImgY = Integer.parseInt(itemValue);
		} else if (itemName.equals("weatherStrX")) {
			weatherStrX = Integer.parseInt(itemValue);
		} else if (itemName.equals("weatherStrY")) {
			weatherStrY = Integer.parseInt(itemValue);
		} else if (itemName.equals("cityX")) {
			cityX = Integer.parseInt(itemValue);
		} else if (itemName.equals("cityY")) {
			cityY = Integer.parseInt(itemValue);
		} else if (itemName.equals("weatherStrfontSize")) {
			weatherStrfontSize = Integer.parseInt(itemValue);
		} else if (itemName.equals("cityfontSize")) {
			cityfontSize = Integer.parseInt(itemValue);
		} else if (itemName.equals("timeX")) {// time
			timeX = Integer.parseInt(itemValue);
		} else if (itemName.equals("timeY")) {
			timeY = Integer.parseInt(itemValue);
		} else if (itemName.equals("wddxX")) {// time
			wddxX = Integer.parseInt(itemValue);
		} else if (itemName.equals("wddxY")) {// time
			wddxY = Integer.parseInt(itemValue);
		} else if (itemName.equals("wjdhX")) {// time
			wjdhX = Integer.parseInt(itemValue);
		} else if (itemName.equals("wjdhY")) {// time
			wjdhY = Integer.parseInt(itemValue);
		} else if (itemName.equals("wdxxfontsize")) {// time
			wdxxfontsize = Integer.parseInt(itemValue);
		...
		// //////////////////////////////////////////
			...
			bgPath = itemValue;
		} else if (itemName.equals("timefontsize")) {// timefontsize
			timefontsize = Integer.parseInt(itemValue);
		} else if (itemName.equals("datefontsize")) {// datefontsize
		...
		} else if (itemName.equals("Powerfontsize")) {// Powerfontsize
			Powerfontsize = Integer.parseInt(itemValue);
		} else if (itemName.equals("powerX")) {// power
		...
		} else if (itemName.equals("usetimeimg")) {
			usetimeimg = itemValue.equals("true");
