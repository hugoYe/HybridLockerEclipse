...
import com.cooeeui.lock.controlcenter.R;
...
//        }
     ...
     * js中用来启动配置的应用程序
     *
     * @param intentUri      [String] (args.getString(0)) : 需要启动的intent ---> example:
     ...
     * @param appId          [long] (args.getString(1)) : 需要配置的appid(微入口所需要配置的参数) ---> example :
     *                       10009
     * @param createShortcut [boolean] (args.getString(2)) : 是否需要创建桌面快捷方式 ，配合title及imgBase64使用
     * @param title          [String] (args.getString(3)) : 创建桌面快捷方式的名称 ---> example: "百度"
     * @param imgBase64      [String] (args.getString(4)) : 创建桌面快捷方式的图标 ---> example:
     ...
     *
     * @param url            [String] (args.getString(0)) : 需要启动的链接 ---> example:
     *                       "http://m.baidu.com"
     * @param createShortcut [boolean] ( args.getBoolean(1)) : 是否需要创建桌面快捷方式 ，配合title及imgBase64使用
     * @param title          [String] (args.getString(2)) : 创建桌面快捷方式的名称 ---> example: "百度"
     * @param imgBase64      [String] (args.getString(3)) : 创建桌面快捷方式的图标 ---> example:
     *                       "data:image/gif;base64, werfjls.."
     */
    ...
    public void bindWebFavoriteApp() {
        cordova.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                ...
                ArrayList<AppInfo>
                    list =
                    FavoritesApi.getInstance()
                        .getFavoriteApp();//Tools.recentTasks(ctx);//mFavorites.getFavoriteApp();
                Log.i(TAG,
