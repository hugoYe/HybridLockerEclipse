...
public class WifiWizard extends CordovaPlugin {
    ...
    private boolean addNetwork(CallbackContext callbackContext, JSONArray data) {
        ...
        try {
            ...
            if (authType.equals("WPA")) {
                ...
                wifi.allowedGroupCiphers
                    .set(WifiConfiguration.GroupCipher.TKIP);
                wifi.allowedGroupCiphers
                    .set(WifiConfiguration.GroupCipher.CCMP);
                wifi.allowedKeyManagement
                    .set(WifiConfiguration.KeyMgmt.WPA_PSK);
                wifi.allowedPairwiseCiphers
            ...
            // TODO: Add more authentications as necessary
                ...
                callbackContext
                    .error("Wifi Authentication Type Not Supported: "
                           + authType);
                return false;
            }
        } catch (Exception e) {
     ...
     */
    private boolean connectNetwork(CallbackContext callbackContext,
                                   JSONArray data) {
     ...
     */
    private boolean disconnectNetwork(CallbackContext callbackContext,
                                      JSONArray data) {
        ...
        if (networkIdToDisconnect > 0) {
            ...
            callbackContext.success("Network " + ssidToDisconnect
                                    + " disconnected!");
            return true;
        } else {
            callbackContext
                .error("Network " + ssidToDisconnect + " not found!");
    ...
    private boolean disconnect(CallbackContext callbackContext) {
        ...
        if (wifiManager.disconnect()) {
            ...
            callbackContext
                .error("Unable to disconnect from the current network");
            return false;
        }
    }
     ...
     */
    private boolean setWifiEnabled(final CallbackContext callbackContext, final JSONArray data) {
