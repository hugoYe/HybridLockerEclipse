...
public class GlassView extends RelativeLayout {
    ...
    private static final float DEFAULT_BLUR_RADIUS = 0;
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray typedArray =
            getContext().obtainStyledAttributes(attrs, R.styleable.BlurParameters);
        mDownSampling =
            typedArray.getInt(R.styleable.BlurParameters_downsampleFactor, DEFAULT_DOWN_SAMPLING);
        setBlurRadius(
            typedArray.getFloat(R.styleable.BlurParameters_blurRadius, DEFAULT_BLUR_RADIUS));
        typedArray.recycle();
    }
    ...
    private void prepBitmaps() {
        ...
        mOrigBitmap = Bitmap.createBitmap((int) (getMeasuredWidth() * mScaleFactor),
                                          (int) (getMeasuredHeight() * mScaleFactor),
