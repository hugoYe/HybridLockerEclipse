package com.cooeeui.lock.core.utilities;
...
public class DeviceUtils {
     ...
     */
    public static int getRealScreenPixelsHeight(Context context) {
        if (context != null) {
            int height = context.getResources().getDisplayMetrics().heightPixels;
            if (SDK_INT == 13) {
                try {
                    Display display = ((WindowManager) context.getSystemService(Context.WINDOW_SERVICE))
                            .getDefaultDisplay(); //activity.getWindowManager().getDefaultDisplay();
