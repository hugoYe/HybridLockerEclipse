...
public class FlingAnimationUtils {
    ...
    public FlingAnimationUtils(Context ctx, float maxLengthSeconds) {
        ...
        mLinearOutSlowIn = PathInterpolatorCompat.create(0, 0, LINEAR_OUT_SLOW_IN_X2, 1);
        mFastOutSlowIn = PathInterpolatorCompat.create(0.4f, 0, 0.2f, 1);
        mFastOutLinearIn = PathInterpolatorCompat.create(0.4f, 0, 1, 1);
...
//            = AnimationUtils.loadInterpolator(ctx, android.R.interpolator.fast_out_linear_in);
    ...
    private AnimatorProperties getProperties(float currValue,
        ...
        float maxLengthSeconds = (float) (mMaxLengthSeconds
                                          * Math
                                              .sqrt(Math.abs(endValue - currValue) / maxDistance));
    ...
    private AnimatorProperties getDismissingProperties(float currValue, float endValue,
                                                       float velocity, float maxDistance) {
        float maxLengthSeconds = (float) (mMaxLengthSeconds
                                          * Math.pow(Math.abs(endValue - currValue) / maxDistance,
                                                     0.5f));
        float diff = Math.abs(endValue - currValue);
        float velAbs = Math.abs(velocity);
        ...
        Interpolator mLinearOutFasterIn = null;
        mLinearOutFasterIn = PathInterpolatorCompat.create(0, 0, LINEAR_OUT_FASTER_IN_X2, y2);

//            mLinearOutFasterIn = new PathInterpolator(0, 0, LINEAR_OUT_FASTER_IN_X2, y2);
