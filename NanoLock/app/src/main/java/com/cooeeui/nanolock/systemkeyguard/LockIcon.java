...
//    private AccessibilityController mAccessibilityController;
    ...
    public LockIcon(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            setBackgroundDrawable(mTrustDrawable);
        }
...
//                                                       mDeviceInteractive, mLastScreenOn,
//                                                       mScreenOn);
...
//        }
        ...
        boolean trustManaged = false;//mUnlockMethodCache.isTrustManaged() && !trustHidden;
