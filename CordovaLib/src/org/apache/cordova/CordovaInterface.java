 ...
 * isolate plugin development, and remove dependency on entire Cordova library.
 */
public interface CordovaInterface {
	 ...
	 *            activity
	 */
	abstract public void startActivityForResult(CordovaPlugin command,
	 ...
	 * 
	 * @param plugin
	 *            The plugin on which onActivityResult is to be called
	 */
