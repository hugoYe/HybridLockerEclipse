 ...
 * document, such as onCreateWindow(), onConsoleMessage(), onProgressChanged(),
 * etc. Related to but different than CordovaWebViewClient.
 */
public class SystemWebChromeClient extends WebChromeClient {
	...
	public SystemWebChromeClient(SystemWebViewEngine parentEngine) {
		...
		dialogsHelper = new CordovaDialogsHelper(
	...
	public boolean onJsPrompt(WebView view, String origin, String message,
		...
		if (handledRet != null) {
			...
			dialogsHelper.showPrompt(message, defaultValue,
					new CordovaDialogsHelper.Result() {
						@Override
						public void gotResult(boolean success, String value) {
							if (success) {
	...
	// API level 7 is required for this, see if we could lower this using
	// something else
	@Override
	...
	public View getVideoLoadingProgressView() {
		...
		if (mVideoProgressView == null) {
			...
			LinearLayout layout = new LinearLayout(parentEngine.getView()
					.getContext());
			...
			// the proress bar
			ProgressBar bar = new ProgressBar(parentEngine.getView()
					.getContext());
	...
	// openFileChooser() is for pre KitKat and in KitKat mr1 (it's known broken
	// in KitKat).
