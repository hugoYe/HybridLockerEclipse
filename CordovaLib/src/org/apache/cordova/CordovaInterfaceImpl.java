...
public class CordovaInterfaceImpl implements CordovaInterface {
	...
	/**
	 * Routes the result to the awaiting plugin. Returns false if no plugin was
	 * waiting.
	 */
	...
	/**
	 * Call this from your startActivityForResult() overload. This is required
	 * to catch the case where plugins use Activity.startActivityForResult() +
	 * CordovaInterface.setActivityResultCallback() rather than
	...
	/**
	 * Call this from onCreate() so that any saved startActivityForResult
